...
Cada projeto listado acima possui um repositório próprio (Nível 3), contendo documentação detalhada sobre escopo, objetivos, metodologia, tecnologias, frameworks utilizados, evidências e aprendizados.

> **Nota de Confidencialidade:** Quando aplicável, informações organizacionais reais, dados sensíveis, endereços de rede ou materiais sujeitos a restrições de confidencialidade foram omitidos, anonimizados ou substituídos por dados de laboratório, preservando a integridade das evidências sem expor ambientes reais.
